...
class CustomSearchDelegate extends SearchDelegate<int> {  
  ...
  Widget buildSuggestions(BuildContext context) {
        ...
        final List<SearchGridTile> allConversions=[
          SearchGridTile(iconAsset: "lunghezza", footer: jsonSearch["lunghezza"], onTap: (){close(context, 0);}),
          SearchGridTile(iconAsset: "area", footer: jsonSearch["superficie"], onTap: (){close(context, 1);}),
          SearchGridTile(iconAsset: "volume", footer: jsonSearch["volume"], onTap: (){close(context, 2);}),
          SearchGridTile(iconAsset: "tempo", footer: jsonSearch["tempo"], onTap: (){close(context, 3);}),
          SearchGridTile(iconAsset: "temperatura", footer: jsonSearch["temperatura"], onTap: (){close(context, 4);}),
          SearchGridTile(iconAsset: "velocita", footer: jsonSearch["velocita"], onTap: (){close(context, 5);}),
          SearchGridTile(iconAsset: "massa", footer: jsonSearch["massa"], onTap: (){close(context, 7);}),
          SearchGridTile(iconAsset: "pressione", footer: jsonSearch["pressione"], onTap: (){close(context, 8);}),
          SearchGridTile(iconAsset: "energia", footer: jsonSearch["energia"], onTap: (){close(context, 9);}),
          SearchGridTile(iconAsset: "angoli", footer: jsonSearch["angoli"], onTap: (){close(context, 10);}),
          SearchGridTile(iconAsset: "valuta", footer: jsonSearch["valuta"], onTap: (){close(context, 11);}),
          SearchGridTile(iconAsset: "potenza", footer: jsonSearch["potenza"], onTap: (){close(context, 14);}),
          SearchGridTile(iconAsset: "forza", footer: jsonSearch["forza"], onTap: (){close(context, 15);}),
          SearchGridTile(iconAsset: "conversione_base", footer: jsonSearch["basi_numeriche"], onTap: (){close(context, 18);}),
          SearchGridTile(iconAsset: "consumo", footer: jsonSearch["consumo_carburante"], onTap: (){close(context, 17);}),
          SearchGridTile(iconAsset: "torque", footer: jsonSearch["momento"], onTap: (){close(context, 16);}),
          SearchGridTile(iconAsset: "dati", footer: jsonSearch["dati_digitali"], onTap: (){close(context, 13);}),
          SearchGridTile(iconAsset: "scarpe", footer: jsonSearch["taglia_scarpe"], onTap: (){close(context, 12);}),
          SearchGridTile(iconAsset: "prefissi", footer: jsonSearch["prefissi_si"], onTap: (){close(context, 6);}),
        ];
