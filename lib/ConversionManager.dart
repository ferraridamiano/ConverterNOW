...
class CustomSearchDelegate extends SearchDelegate<int> {  
  ...
  Widget buildSuggestions(BuildContext context) {
        final List<SearchUnit> _dataSearch=[
          ...
          SearchUnit(iconAsset: "angoli", unitName: jsonSearch["angoli"], onTap: (){close(context, 10);}),
          SearchUnit(iconAsset: "angoli", unitName: jsonSearch["gradi"], onTap: (){close(context, 10);}),
          SearchUnit(iconAsset: "angoli", unitName: jsonSearch["primi"], onTap: (){close(context, 10);}),
          SearchUnit(iconAsset: "angoli", unitName: jsonSearch["secondi"], onTap: (){close(context, 10);}),
          SearchUnit(iconAsset: "angoli", unitName: jsonSearch["radianti"], onTap: (){close(context, 10);}),

          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["valuta"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["USD"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["EUR"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["GBP"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["INR"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["CNY"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["JPY"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["CHF"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["SEK"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["RUB"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["CAD"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["KRW"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["BRL"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["HKD"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["AUD"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["NZD"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["MXN"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["SGD"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["NOK"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["TRY"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["ZAR"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["DKK"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["PLN"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["THB"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["MYR"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["HUF"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["CZK"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["ILS"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["IDR"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["PHP"], onTap: (){close(context, 11);}),
          SearchUnit(iconAsset: "valuta", unitName: jsonSearch["RON"], onTap: (){close(context, 11);}),

          SearchUnit(iconAsset: "scarpe", unitName: jsonSearch["taglia_scarpe"], onTap: (){close(context, 12);}),

          SearchUnit(iconAsset: "dati", unitName: jsonSearch["dati_digitali"], onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Bit", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Nibble", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Kilobit", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Megabit", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Gigabit", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Terabit", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Petabit", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Exabit", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Kibibit", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Mebibit", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Gibibit", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Tebibit", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Pebibit", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Exbibit", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Byte", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Kilobyte", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Megabyte", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Gigabyte", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Terabyte", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Petabyte", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Kibibyte", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Mebibyte", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Gibibyte", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Tebibyte", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Pebibyte", onTap: (){close(context, 13);}),
          SearchUnit(iconAsset: "dati", unitName: "Exbibyte", onTap: (){close(context, 13);}),

          SearchUnit(iconAsset: "potenza", unitName: jsonSearch["potenza"], onTap: (){close(context, 14);}),
          SearchUnit(iconAsset: "potenza", unitName: jsonSearch["watt"], onTap: (){close(context, 14);}),
          SearchUnit(iconAsset: "potenza", unitName: jsonSearch["milliwatt"], onTap: (){close(context, 14);}),
          SearchUnit(iconAsset: "potenza", unitName: jsonSearch["kilowatt"], onTap: (){close(context, 14);}),
          SearchUnit(iconAsset: "potenza", unitName: jsonSearch["megawatt"], onTap: (){close(context, 14);}),
          SearchUnit(iconAsset: "potenza", unitName: jsonSearch["gigawatt"], onTap: (){close(context, 14);}),
          SearchUnit(iconAsset: "potenza", unitName: jsonSearch["cavallo_vapore_eurpeo"], onTap: (){close(context, 14);}),
          SearchUnit(iconAsset: "potenza", unitName: jsonSearch["cavallo_vapore_imperiale"], onTap: (){close(context, 14);}),

          SearchUnit(iconAsset: "forza", unitName: jsonSearch["forza"], onTap: (){close(context, 15);}),
          SearchUnit(iconAsset: "forza", unitName: jsonSearch["newton"], onTap: (){close(context, 15);}),
          SearchUnit(iconAsset: "forza", unitName: jsonSearch["dyne"], onTap: (){close(context, 15);}),
          SearchUnit(iconAsset: "forza", unitName: jsonSearch["libbra_forza"], onTap: (){close(context, 15);}),
          SearchUnit(iconAsset: "forza", unitName: jsonSearch["kilogrammo_forza"], onTap: (){close(context, 15);}),
          SearchUnit(iconAsset: "forza", unitName: jsonSearch["poundal"], onTap: (){close(context, 15);}),

          SearchUnit(iconAsset: "torque", unitName: jsonSearch["momento"], onTap: (){close(context, 16);}),
          SearchUnit(iconAsset: "torque", unitName: jsonSearch["newton_metro"], onTap: (){close(context, 16);}),
          SearchUnit(iconAsset: "torque", unitName: jsonSearch["dyne_metro"], onTap: (){close(context, 16);}),
          ...
          SearchUnit(iconAsset: "consumo", unitName: jsonSearch["miglia_gallone_us"], onTap: (){close(context, 17);}),
          SearchUnit(iconAsset: "consumo", unitName: jsonSearch["miglia_gallone_uk"], onTap: (){close(context, 17);}),

          SearchUnit(iconAsset: "conversione_base", unitName: jsonSearch["basi_numeriche"], onTap: (){close(context, 18);}),
          SearchUnit(iconAsset: "conversione_base", unitName: jsonSearch["decimale"], onTap: (){close(context, 18);}),
          SearchUnit(iconAsset: "conversione_base", unitName: jsonSearch["esadecimale"], onTap: (){close(context, 18);}),
          SearchUnit(iconAsset: "conversione_base", unitName: jsonSearch["ottale"], onTap: (){close(context, 18);}),
          SearchUnit(iconAsset: "conversione_base", unitName: jsonSearch["binario"], onTap: (){close(context, 18);}),


        ];

        final List<SearchGridTile> allConversions=[
          SearchGridTile(iconAsset: "lunghezza", footer: jsonSearch["lunghezza"], onTap: (){close(context, 0);}, darkMode: MediaQuery.of(context).platformBrightness==Brightness.dark,),
          SearchGridTile(iconAsset: "area", footer: jsonSearch["superficie"], onTap: (){close(context, 1);}, darkMode: MediaQuery.of(context).platformBrightness==Brightness.dark,),
          SearchGridTile(iconAsset: "volume", footer: jsonSearch["volume"], onTap: (){close(context, 2);}, darkMode: MediaQuery.of(context).platformBrightness==Brightness.dark,),
          SearchGridTile(iconAsset: "tempo", footer: jsonSearch["tempo"], onTap: (){close(context, 3);}, darkMode: MediaQuery.of(context).platformBrightness==Brightness.dark,),
          SearchGridTile(iconAsset: "temperatura", footer: jsonSearch["temperatura"], onTap: (){close(context, 4);}, darkMode: MediaQuery.of(context).platformBrightness==Brightness.dark,),
          SearchGridTile(iconAsset: "velocita", footer: jsonSearch["velocita"], onTap: (){close(context, 5);}, darkMode: MediaQuery.of(context).platformBrightness==Brightness.dark,),
          SearchGridTile(iconAsset: "massa", footer: jsonSearch["massa"], onTap: (){close(context, 7);}, darkMode: MediaQuery.of(context).platformBrightness==Brightness.dark,),
          SearchGridTile(iconAsset: "pressione", footer: jsonSearch["pressione"], onTap: (){close(context, 8);}, darkMode: MediaQuery.of(context).platformBrightness==Brightness.dark,),
          SearchGridTile(iconAsset: "energia", footer: jsonSearch["energia"], onTap: (){close(context, 9);}, darkMode: MediaQuery.of(context).platformBrightness==Brightness.dark,),
          SearchGridTile(iconAsset: "angoli", footer: jsonSearch["angoli"], onTap: (){close(context, 10);}, darkMode: MediaQuery.of(context).platformBrightness==Brightness.dark,),
          SearchGridTile(iconAsset: "valuta", footer: jsonSearch["valuta"], onTap: (){close(context, 11);}, darkMode: MediaQuery.of(context).platformBrightness==Brightness.dark,),
          SearchGridTile(iconAsset: "potenza", footer: jsonSearch["potenza"], onTap: (){close(context, 14);}, darkMode: MediaQuery.of(context).platformBrightness==Brightness.dark,),
          SearchGridTile(iconAsset: "forza", footer: jsonSearch["forza"], onTap: (){close(context, 15);}, darkMode: MediaQuery.of(context).platformBrightness==Brightness.dark,),
          SearchGridTile(iconAsset: "conversione_base", footer: jsonSearch["basi_numeriche"], onTap: (){close(context, 18);}, darkMode: MediaQuery.of(context).platformBrightness==Brightness.dark,),
          SearchGridTile(iconAsset: "consumo", footer: jsonSearch["consumo_carburante"], onTap: (){close(context, 17);}, darkMode: MediaQuery.of(context).platformBrightness==Brightness.dark,),
          SearchGridTile(iconAsset: "torque", footer: jsonSearch["momento"], onTap: (){close(context, 16);}, darkMode: MediaQuery.of(context).platformBrightness==Brightness.dark,),
          SearchGridTile(iconAsset: "dati", footer: jsonSearch["dati_digitali"], onTap: (){close(context, 13);}, darkMode: MediaQuery.of(context).platformBrightness==Brightness.dark,),
          SearchGridTile(iconAsset: "scarpe", footer: jsonSearch["taglia_scarpe"], onTap: (){close(context, 12);}, darkMode: MediaQuery.of(context).platformBrightness==Brightness.dark,),
          SearchGridTile(iconAsset: "prefissi", footer: jsonSearch["prefissi_si"], onTap: (){close(context, 6);}, darkMode: MediaQuery.of(context).platformBrightness==Brightness.dark,),
        ];
