...
List<PropertyUi> getPropertyUiList(BuildContext context) {
  ...
  propertyUiList
    ...
    ..add(PropertyUi(PROPERTYX.FUEL_CONSUMPTION, AppLocalizations.of(context)!.fuelConsumption, basePath + 'fuel.png'))
    ..add(PropertyUi(PROPERTYX.NUMERAL_SYSTEMS, AppLocalizations.of(context)!.numeralSystems, basePath + 'num_systems.png'))
    ...
    ..add(PropertyUi(PROPERTYX.SHOE_SIZE, AppLocalizations.of(context)!.shoeSize, basePath + 'shoe_size.png'))
    ..add(PropertyUi(PROPERTYX.DIGITAL_DATA, AppLocalizations.of(context)!.digitalData, basePath + 'data.png'))
    ..add(PropertyUi(PROPERTYX.SI_PREFIXES, AppLocalizations.of(context)!.siPrefixes, basePath + 'prefixes.png'))
...
List<UnitUi> getUnitUiList(BuildContext context) {
  ...
  unitUiList
    ...
    ..add(UnitUi(LENGTH.astronomical_units, AppLocalizations.of(context)!.astronomicalUnits, basePath + 'length.png', PROPERTYX.LENGTH))
    ..add(UnitUi(LENGTH.light_years, AppLocalizations.of(context)!.lightYears, basePath + 'length.png', PROPERTYX.LENGTH))
    ..add(UnitUi(LENGTH.parsec, AppLocalizations.of(context)!.parsec, basePath + 'length.png', PROPERTYX.LENGTH))
    ..add(UnitUi(AREA.square_meters, AppLocalizations.of(context)!.squareMeters, basePath + 'area.png', PROPERTYX.AREA))
    ..add(UnitUi(AREA.square_centimeters, AppLocalizations.of(context)!.squareCentimeters, basePath + 'area.png', PROPERTYX.AREA))
    ..add(UnitUi(AREA.square_inches, AppLocalizations.of(context)!.squareInches, basePath + 'area.png', PROPERTYX.AREA))
    ..add(UnitUi(AREA.square_feet, AppLocalizations.of(context)!.squareFeet, basePath + 'area.png', PROPERTYX.AREA))
    ..add(UnitUi(AREA.square_miles, AppLocalizations.of(context)!.squareMiles, basePath + 'area.png', PROPERTYX.AREA))
    ..add(UnitUi(AREA.square_yard, AppLocalizations.of(context)!.squareYard, basePath + 'area.png', PROPERTYX.AREA))
    ..add(UnitUi(AREA.square_millimeters, AppLocalizations.of(context)!.squareMillimeters, basePath + 'area.png', PROPERTYX.AREA))
    ..add(UnitUi(AREA.square_kilometers, AppLocalizations.of(context)!.squareKilometers, basePath + 'area.png', PROPERTYX.AREA))
    ...
    ..add(UnitUi(VOLUME.cubic_meters, AppLocalizations.of(context)!.cubicMeters, basePath + 'volume.png', PROPERTYX.VOLUME))
    ..add(UnitUi(VOLUME.liters, AppLocalizations.of(context)!.liters, basePath + 'volume.png', PROPERTYX.VOLUME))
    ..add(UnitUi(VOLUME.imperial_gallons, AppLocalizations.of(context)!.imperialGallons, basePath + 'volume.png', PROPERTYX.VOLUME))
    ..add(UnitUi(VOLUME.us_gallons, AppLocalizations.of(context)!.usGallons, basePath + 'volume.png', PROPERTYX.VOLUME))
    ..add(UnitUi(VOLUME.imperial_pints, AppLocalizations.of(context)!.imperialPints, basePath + 'volume.png', PROPERTYX.VOLUME))
    ..add(UnitUi(VOLUME.us_pints, AppLocalizations.of(context)!.usPints, basePath + 'volume.png', PROPERTYX.VOLUME))
    ..add(UnitUi(VOLUME.milliliters, AppLocalizations.of(context)!.milliliters, basePath + 'volume.png', PROPERTYX.VOLUME))
    ..add(UnitUi(VOLUME.tablespoons_us, AppLocalizations.of(context)!.tablespoonUs, basePath + 'volume.png', PROPERTYX.VOLUME))
    ..add(UnitUi(VOLUME.australian_tablespoons, AppLocalizations.of(context)!.tablespoonAustralian, basePath + 'volume.png', PROPERTYX.VOLUME))
    ..add(UnitUi(VOLUME.cups, AppLocalizations.of(context)!.cups, basePath + 'volume.png', PROPERTYX.VOLUME))
    ..add(UnitUi(VOLUME.cubic_centimeters, AppLocalizations.of(context)!.cubicCentimeters, basePath + 'volume.png', PROPERTYX.VOLUME))
    ..add(UnitUi(VOLUME.cubic_feet, AppLocalizations.of(context)!.cubicFeet, basePath + 'volume.png', PROPERTYX.VOLUME))
    ..add(UnitUi(VOLUME.cubic_inches, AppLocalizations.of(context)!.cubicInches, basePath + 'volume.png', PROPERTYX.VOLUME))
    ..add(UnitUi(VOLUME.cubic_millimeters, AppLocalizations.of(context)!.cubicMillimeters, basePath + 'volume.png', PROPERTYX.VOLUME))
    ..add(UnitUi(VOLUME.us_fluid_ounces, AppLocalizations.of(context)!.usFluidOunces, basePath + 'volume.png', PROPERTYX.VOLUME))
    ..add(UnitUi(VOLUME.imperial_fluid_ounces, AppLocalizations.of(context)!.imperialFluidOunces, basePath + 'volume.png', PROPERTYX.VOLUME))
    ..add(UnitUi(VOLUME.us_gill, AppLocalizations.of(context)!.usGill, basePath + 'volume.png', PROPERTYX.VOLUME))
    ..add(UnitUi(VOLUME.imperial_gill, AppLocalizations.of(context)!.imperialGill, basePath + 'volume.png', PROPERTYX.VOLUME))
    ...
    ..add(UnitUi(TIME.years_365, AppLocalizations.of(context)!.years, basePath + 'time.png', PROPERTYX.TIME))
    ...
    ..add(UnitUi(SPEED.meters_per_second, AppLocalizations.of(context)!.metersSecond, basePath + 'speed.png', PROPERTYX.SPEED))
    ..add(UnitUi(SPEED.kilometers_per_hour, AppLocalizations.of(context)!.kilometersHour, basePath + 'speed.png', PROPERTYX.SPEED))
    ..add(UnitUi(SPEED.miles_per_hour, AppLocalizations.of(context)!.milesHour, basePath + 'speed.png', PROPERTYX.SPEED))
    ..add(UnitUi(SPEED.knots, AppLocalizations.of(context)!.knots, basePath + 'speed.png', PROPERTYX.SPEED))
    ..add(UnitUi(SPEED.feets_per_second, AppLocalizations.of(context)!.feetSecond, basePath + 'speed.png', PROPERTYX.SPEED))
    ...
    ..add(UnitUi(MASS.troy_ounces, AppLocalizations.of(context)!.troyOunces, basePath + 'mass.png', PROPERTYX.MASS))
    ...
    ..add(UnitUi(FORCE.pound_force, AppLocalizations.of(context)!.poundForce, basePath + 'force.png', PROPERTYX.FORCE))
    ..add(UnitUi(FORCE.kilogram_force, AppLocalizations.of(context)!.kilogramForce, basePath + 'force.png', PROPERTYX.FORCE))
    ...
    ..add(UnitUi(FUEL_CONSUMPTION.liters_per_100_km, AppLocalizations.of(context)!.liters100km, basePath + 'fuel.png', PROPERTYX.FUEL_CONSUMPTION))
    ..add(UnitUi(FUEL_CONSUMPTION.miles_per_US_gallon, AppLocalizations.of(context)!.milesUsGallon, basePath + 'fuel.png', PROPERTYX.FUEL_CONSUMPTION))
    ..add(UnitUi(
        FUEL_CONSUMPTION.miles_per_imperial_gallon, AppLocalizations.of(context)!.milesImperialGallon, basePath + 'fuel.png', PROPERTYX.FUEL_CONSUMPTION))
    ..add(UnitUi(NUMERAL_SYSTEMS.decimal, AppLocalizations.of(context)!.decimal, basePath + 'num_systems.png', PROPERTYX.NUMERAL_SYSTEMS))
    ..add(UnitUi(NUMERAL_SYSTEMS.hexadecimal, AppLocalizations.of(context)!.hexadecimal, basePath + 'num_systems.png', PROPERTYX.NUMERAL_SYSTEMS))
    ..add(UnitUi(NUMERAL_SYSTEMS.octal, AppLocalizations.of(context)!.octal, basePath + 'num_systems.png', PROPERTYX.NUMERAL_SYSTEMS))
    ..add(UnitUi(NUMERAL_SYSTEMS.binary, AppLocalizations.of(context)!.binary, basePath + 'num_systems.png', PROPERTYX.NUMERAL_SYSTEMS))
    ...
    ..add(UnitUi(ENERGY.kilowatt_hours, AppLocalizations.of(context)!.kilowattHour, basePath + 'energy.png', PROPERTYX.ENERGY))
    ...
    ..add(UnitUi(POWER.european_horse_power, AppLocalizations.of(context)!.europeanHorsePower, basePath + 'power.png', PROPERTYX.POWER))
    ..add(UnitUi(POWER.imperial_horse_power, AppLocalizations.of(context)!.imperialHorsePower, basePath + 'power.png', PROPERTYX.POWER))
    ...
    ..add(UnitUi(SHOE_SIZE.centimeters, AppLocalizations.of(context)!.centimeters, basePath + 'shoe_size.png', PROPERTYX.SHOE_SIZE))
    ..add(UnitUi(SHOE_SIZE.inches, AppLocalizations.of(context)!.inches, basePath + 'shoe_size.png', PROPERTYX.SHOE_SIZE))
    ..add(UnitUi(SHOE_SIZE.eu_china, AppLocalizations.of(context)!.euChina, basePath + 'shoe_size.png', PROPERTYX.SHOE_SIZE))
    ..add(UnitUi(SHOE_SIZE.uk_india_child, AppLocalizations.of(context)!.ukIndiaChild, basePath + 'shoe_size.png', PROPERTYX.SHOE_SIZE))
    ..add(UnitUi(SHOE_SIZE.uk_india_man, AppLocalizations.of(context)!.ukIndiaMan, basePath + 'shoe_size.png', PROPERTYX.SHOE_SIZE))
    ..add(UnitUi(SHOE_SIZE.uk_india_woman, AppLocalizations.of(context)!.ukIndiaWoman, basePath + 'shoe_size.png', PROPERTYX.SHOE_SIZE))
    ..add(UnitUi(SHOE_SIZE.usa_canada_child, AppLocalizations.of(context)!.usaCanadaChild, basePath + 'shoe_size.png', PROPERTYX.SHOE_SIZE))
    ..add(UnitUi(SHOE_SIZE.usa_canada_man, AppLocalizations.of(context)!.usaCanadaMan, basePath + 'shoe_size.png', PROPERTYX.SHOE_SIZE))
    ..add(UnitUi(SHOE_SIZE.usa_canada_woman, AppLocalizations.of(context)!.usaCanadaWoman, basePath + 'shoe_size.png', PROPERTYX.SHOE_SIZE))
    ..add(UnitUi(SHOE_SIZE.japan, AppLocalizations.of(context)!.japan, basePath + 'shoe_size.png', PROPERTYX.SHOE_SIZE))
    ..add(UnitUi(DIGITAL_DATA.bit, AppLocalizations.of(context)!.bit, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.nibble, AppLocalizations.of(context)!.nibble, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.kilobit, AppLocalizations.of(context)!.kilobit, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.megabit, AppLocalizations.of(context)!.megabit, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.gigabit, AppLocalizations.of(context)!.gigabit, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.terabit, AppLocalizations.of(context)!.terabit, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.petabit, AppLocalizations.of(context)!.petabit, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.exabit, AppLocalizations.of(context)!.exabit, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.kibibit, AppLocalizations.of(context)!.kibibit, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.mebibit, AppLocalizations.of(context)!.mebibit, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.gibibit, AppLocalizations.of(context)!.gibibit, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.tebibit, AppLocalizations.of(context)!.tebibit, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.pebibit, AppLocalizations.of(context)!.pebibit, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.exbibit, AppLocalizations.of(context)!.exbibit, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.byte, AppLocalizations.of(context)!.byte, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.kilobyte, AppLocalizations.of(context)!.kilobyte, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.megabyte, AppLocalizations.of(context)!.megabyte, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.gigabyte, AppLocalizations.of(context)!.gigabyte, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.terabyte, AppLocalizations.of(context)!.terabyte, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.petabyte, AppLocalizations.of(context)!.petabyte, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.exabyte, AppLocalizations.of(context)!.exabyte, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.kibibyte, AppLocalizations.of(context)!.kibibyte, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.mebibyte, AppLocalizations.of(context)!.mebibyte, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.gibibyte, AppLocalizations.of(context)!.gibibyte, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.tebibyte, AppLocalizations.of(context)!.tebibyte, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.pebibyte, AppLocalizations.of(context)!.pebibyte, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(DIGITAL_DATA.exbibyte, AppLocalizations.of(context)!.exbibyte, basePath + 'data.png', PROPERTYX.DIGITAL_DATA))
    ..add(UnitUi(SI_PREFIXES.base, AppLocalizations.of(context)!.base, basePath + 'prefixes.png', PROPERTYX.SI_PREFIXES))
    ..add(UnitUi(SI_PREFIXES.deca, AppLocalizations.of(context)!.deca, basePath + 'prefixes.png', PROPERTYX.SI_PREFIXES))
    ..add(UnitUi(SI_PREFIXES.hecto, AppLocalizations.of(context)!.hecto, basePath + 'prefixes.png', PROPERTYX.SI_PREFIXES))
    ..add(UnitUi(SI_PREFIXES.kilo, AppLocalizations.of(context)!.kilo, basePath + 'prefixes.png', PROPERTYX.SI_PREFIXES))
    ..add(UnitUi(SI_PREFIXES.mega, AppLocalizations.of(context)!.mega, basePath + 'prefixes.png', PROPERTYX.SI_PREFIXES))
    ..add(UnitUi(SI_PREFIXES.giga, AppLocalizations.of(context)!.giga, basePath + 'prefixes.png', PROPERTYX.SI_PREFIXES))
    ..add(UnitUi(SI_PREFIXES.tera, AppLocalizations.of(context)!.tera, basePath + 'prefixes.png', PROPERTYX.SI_PREFIXES))
    ..add(UnitUi(SI_PREFIXES.peta, AppLocalizations.of(context)!.peta, basePath + 'prefixes.png', PROPERTYX.SI_PREFIXES))
    ..add(UnitUi(SI_PREFIXES.exa, AppLocalizations.of(context)!.exa, basePath + 'prefixes.png', PROPERTYX.SI_PREFIXES))
    ..add(UnitUi(SI_PREFIXES.zetta, AppLocalizations.of(context)!.zetta, basePath + 'prefixes.png', PROPERTYX.SI_PREFIXES))
    ..add(UnitUi(SI_PREFIXES.yotta, AppLocalizations.of(context)!.yotta, basePath + 'prefixes.png', PROPERTYX.SI_PREFIXES))
    ..add(UnitUi(SI_PREFIXES.deci, AppLocalizations.of(context)!.deci, basePath + 'prefixes.png', PROPERTYX.SI_PREFIXES))
    ..add(UnitUi(SI_PREFIXES.centi, AppLocalizations.of(context)!.centi, basePath + 'prefixes.png', PROPERTYX.SI_PREFIXES))
    ..add(UnitUi(SI_PREFIXES.milli, AppLocalizations.of(context)!.milli, basePath + 'prefixes.png', PROPERTYX.SI_PREFIXES))
    ..add(UnitUi(SI_PREFIXES.micro, AppLocalizations.of(context)!.micro, basePath + 'prefixes.png', PROPERTYX.SI_PREFIXES))
    ..add(UnitUi(SI_PREFIXES.nano, AppLocalizations.of(context)!.nano, basePath + 'prefixes.png', PROPERTYX.SI_PREFIXES))
    ..add(UnitUi(SI_PREFIXES.pico, AppLocalizations.of(context)!.pico, basePath + 'prefixes.png', PROPERTYX.SI_PREFIXES))
    ..add(UnitUi(SI_PREFIXES.femto, AppLocalizations.of(context)!.femto, basePath + 'prefixes.png', PROPERTYX.SI_PREFIXES))
    ..add(UnitUi(SI_PREFIXES.atto, AppLocalizations.of(context)!.atto, basePath + 'prefixes.png', PROPERTYX.SI_PREFIXES))
    ..add(UnitUi(SI_PREFIXES.zepto, AppLocalizations.of(context)!.zepto, basePath + 'prefixes.png', PROPERTYX.SI_PREFIXES))
    ..add(UnitUi(SI_PREFIXES.yocto, AppLocalizations.of(context)!.yocto, basePath + 'prefixes.png', PROPERTYX.SI_PREFIXES))
    ..add(UnitUi(TORQUE.newton_meter, AppLocalizations.of(context)!.newtonMeter, basePath + 'torque.png', PROPERTYX.TORQUE))
    ..add(UnitUi(TORQUE.dyne_meter, AppLocalizations.of(context)!.dyneMeter, basePath + 'torque.png', PROPERTYX.TORQUE))
    ..add(UnitUi(TORQUE.pound_force_feet, AppLocalizations.of(context)!.poundForceFeet, basePath + 'torque.png', PROPERTYX.TORQUE))
    ..add(UnitUi(TORQUE.kilogram_force_meter, AppLocalizations.of(context)!.kilogramForceMeter, basePath + 'torque.png', PROPERTYX.TORQUE))
    ..add(UnitUi(TORQUE.poundal_meter, AppLocalizations.of(context)!.poundalMeter, basePath + 'torque.png', PROPERTYX.TORQUE));
