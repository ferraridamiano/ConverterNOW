...
List<UnitUi> getUnitUiList(BuildContext context) {
  ...
  return [
    ...
    UnitUi(VOLUME.imperialGill, l10n.imperialGill, '$basePath/volume.svg.vec',
        PROPERTYX.volume),
    UnitUi(VOLUME.usQuarts, l10n.usQuarts, '$basePath/volume.svg.vec',
        PROPERTYX.volume),
    UnitUi(VOLUME.femtoliters, l10n.femtoliters, '$basePath/volume.svg.vec',
        PROPERTYX.volume),
    UnitUi(VOLUME.picoliters, l10n.picoliters, '$basePath/volume.svg.vec',
        PROPERTYX.volume),
    UnitUi(VOLUME.nanoliters, l10n.nanoliters, '$basePath/volume.svg.vec',
        PROPERTYX.volume),
    UnitUi(VOLUME.microliters, l10n.microliters, '$basePath/volume.svg.vec',
        PROPERTYX.volume),
    UnitUi(VOLUME.deciliters, l10n.deciliters, '$basePath/volume.svg.vec',
        PROPERTYX.volume),
    UnitUi(VOLUME.centiliters, l10n.centiliters, '$basePath/volume.svg.vec',
        PROPERTYX.volume),
    UnitUi(
    ...
    UnitUi(MASS.femtograms, l10n.femtograms, '$basePath/mass.svg.vec',
        PROPERTYX.mass),
    UnitUi(MASS.picograms, l10n.picograms, '$basePath/mass.svg.vec',
        PROPERTYX.mass),
    UnitUi(MASS.nanograms, l10n.nanograms, '$basePath/mass.svg.vec',
        PROPERTYX.mass),
    UnitUi(MASS.micrograms, l10n.micrograms, '$basePath/mass.svg.vec',
        PROPERTYX.mass),
    UnitUi(MASS.decigrams, l10n.decigrams, '$basePath/mass.svg.vec',
        PROPERTYX.mass),
    UnitUi(
