...
List<UnitUi> getUnitUiList(BuildContext context) {
  ...
  unitUiList
    ...
    ..add(UnitUi(FUEL_CONSUMPTION.kilometers_per_liter, AppLocalizations.of(context)!.kilometersLiter, basePath + 'fuel.png', PROPERTYX.fuelConsumption))
    ..add(UnitUi(FUEL_CONSUMPTION.liters_per_100_km, AppLocalizations.of(context)!.liters100km, basePath + 'fuel.png', PROPERTYX.fuelConsumption))
    ..add(UnitUi(FUEL_CONSUMPTION.miles_per_US_gallon, AppLocalizations.of(context)!.milesUsGallon, basePath + 'fuel.png', PROPERTYX.fuelConsumption))
    ..add(UnitUi(
        FUEL_CONSUMPTION.miles_per_imperial_gallon, AppLocalizations.of(context)!.milesImperialGallon, basePath + 'fuel.png', PROPERTYX.fuelConsumption))
    ...
    ..add(UnitUi(SHOE_SIZE.eu_china, AppLocalizations.of(context)!.euChina, basePath + 'shoe_size.png', PROPERTYX.shoeSize))
    ..add(UnitUi(SHOE_SIZE.uk_india_child, AppLocalizations.of(context)!.ukIndiaChild, basePath + 'shoe_size.png', PROPERTYX.shoeSize))
    ..add(UnitUi(SHOE_SIZE.uk_india_man, AppLocalizations.of(context)!.ukIndiaMan, basePath + 'shoe_size.png', PROPERTYX.shoeSize))
    ..add(UnitUi(SHOE_SIZE.uk_india_woman, AppLocalizations.of(context)!.ukIndiaWoman, basePath + 'shoe_size.png', PROPERTYX.shoeSize))
    ..add(UnitUi(SHOE_SIZE.usa_canada_child, AppLocalizations.of(context)!.usaCanadaChild, basePath + 'shoe_size.png', PROPERTYX.shoeSize))
    ..add(UnitUi(SHOE_SIZE.usa_canada_man, AppLocalizations.of(context)!.usaCanadaMan, basePath + 'shoe_size.png', PROPERTYX.shoeSize))
    ..add(UnitUi(SHOE_SIZE.usa_canada_woman, AppLocalizations.of(context)!.usaCanadaWoman, basePath + 'shoe_size.png', PROPERTYX.shoeSize))
